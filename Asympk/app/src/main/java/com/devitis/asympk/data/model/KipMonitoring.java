...
/**
 * Created by Diana on 07.05.2019.
 */

public class KipMonitoring {
    ...
    public KipMonitoring(String id, String checkDataTime, String current, String voltage, String sumPot, String polPot) {
        this.id = id;
